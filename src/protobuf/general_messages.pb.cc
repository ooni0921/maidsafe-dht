...
void protobuf_AssignDesc_general_5fmessages_2eproto() {
  ...
  KadConfig_descriptor_ = file->message_type(1);
...
void protobuf_AddDesc_general_5fmessages_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "lResponse\022\016\n\006result\030\001 \002(\014\"\320\001\n\tKadConfig\022"
    "\014\n\004port\030\001 \001(\005\022(\n\007contact\030\002 \003(\0132\027.base.Ka"
    "dConfig.Contact\032\212\001\n\007Contact\022\017\n\007node_id\030\001"
    " \002(\014\022\n\n\002ip\030\002 \002(\014\022\014\n\004port\030\003 \002(\005\022\020\n\010local_"
    "ip\030\004 \001(\014\022\022\n\nlocal_port\030\005 \001(\005\022\025\n\rrendezvo"
    "uz_ip\030\006 \001(\014\022\027\n\017rendezvouz_port\030\007 \001(\005", 276);
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
       ...
       parse_rendezvouz_ip:
        DO_(::google::protobuf::internal::WireFormatLite::ReadBytes(
              input, this->mutable_rendezvouz_ip()));
...
void KadConfig_Contact::SerializeWithCachedSizes(
  ...
  if (_has_bit(5)) {
    ::google::protobuf::internal::WireFormatLite::WriteBytes(
      6, this->rendezvouz_ip(), output);
  }
  
  // optional int32 rendezvouz_port = 7;
  if (_has_bit(6)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(7, this->rendezvouz_port(), output);
  }
...
::google::protobuf::uint8* KadConfig_Contact::SerializeWithCachedSizesToArray(
  ...
  if (_has_bit(5)) {
    target =
      ::google::protobuf::internal::WireFormatLite::WriteBytesToArray(
        6, this->rendezvouz_ip(), target);
  }
  
  // optional int32 rendezvouz_port = 7;
  if (_has_bit(6)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(7, this->rendezvouz_port(), target);
  }
...
::google::protobuf::Metadata KadConfig_Contact::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = KadConfig_Contact_descriptor_;
  metadata.reflection = KadConfig_Contact_reflection_;
  return metadata;
}
...
::google::protobuf::Metadata KadConfig::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = KadConfig_descriptor_;
  metadata.reflection = KadConfig_reflection_;
  return metadata;
}
