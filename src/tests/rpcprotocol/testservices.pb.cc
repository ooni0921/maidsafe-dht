...
::google::protobuf::Metadata BinaryOpRequest::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = BinaryOpRequest_descriptor_;
  metadata.reflection = BinaryOpRequest_reflection_;
  return metadata;
}
...
::google::protobuf::Metadata BinaryOpResponse::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = BinaryOpResponse_descriptor_;
  metadata.reflection = BinaryOpResponse_reflection_;
  return metadata;
}
...
void StringMirrorRequest::SerializeWithCachedSizes(
  ...
  // optional bool not_pause = 4;
  if (_has_bit(3)) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(4, this->not_pause(), output);
  }
...
::google::protobuf::uint8* StringMirrorRequest::SerializeWithCachedSizesToArray(
  ...
  // optional bool not_pause = 4;
  if (_has_bit(3)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(4, this->not_pause(), target);
  }
...
::google::protobuf::Metadata StringMirrorRequest::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = StringMirrorRequest_descriptor_;
  metadata.reflection = StringMirrorRequest_reflection_;
  return metadata;
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        DO_(::google::protobuf::internal::WireFormatLite::ReadString(
              input, this->mutable_mirrored_string()));
        ::google::protobuf::internal::WireFormat::VerifyUTF8String(
          this->mirrored_string().data(), this->mirrored_string().length(),
          ::google::protobuf::internal::WireFormat::PARSE);
        if (input->ExpectAtEnd()) return true;
        break;
      }
...
::google::protobuf::Metadata StringMirrorResponse::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = StringMirrorResponse_descriptor_;
  metadata.reflection = StringMirrorResponse_reflection_;
  return metadata;
}
