...
void TransportMessage::InitAsDefaultInstance() {
  rpc_msg_ = const_cast< ::rpcprotocol::RpcMessage*>(&::rpcprotocol::RpcMessage::default_instance());
...
void TransportMessage::SerializeWithCachedSizes(
  ...
  if (_has_bit(0)) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageNoVirtual(
      1, this->rpc_msg(), output);
  }
  
  // optional .transport.HolePunchingMsg hp_msg = 2;
  if (_has_bit(1)) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageNoVirtual(
      2, this->hp_msg(), output);
  }
