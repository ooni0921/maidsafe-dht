...
class FindResponse : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_alternative_value_holder() const;
  inline void clear_alternative_value_holder();
  static const int kAlternativeValueHolderFieldNumber = 4;
  inline const ::kad::ContactInfo& alternative_value_holder() const;
  inline ::kad::ContactInfo* mutable_alternative_value_holder();
  
  // optional bytes needs_cache_copy = 5;
  inline bool has_needs_cache_copy() const;
  inline void clear_needs_cache_copy();
  static const int kNeedsCacheCopyFieldNumber = 5;
  inline const ::std::string& needs_cache_copy() const;
  inline void set_needs_cache_copy(const ::std::string& value);
  inline void set_needs_cache_copy(const char* value);
  inline void set_needs_cache_copy(const void* value, size_t size);
  inline ::std::string* mutable_needs_cache_copy();
  
  // optional bytes requester_ext_addr = 6;
  inline bool has_requester_ext_addr() const;
  inline void clear_requester_ext_addr();
  static const int kRequesterExtAddrFieldNumber = 6;
 ...
 private:
  ...
  ::kad::ContactInfo* alternative_value_holder_;
  ::std::string* needs_cache_copy_;
  static const ::std::string _default_needs_cache_copy_;
...
// optional .kad.ContactInfo alternative_value_holder = 4;
inline bool FindResponse::has_alternative_value_holder() const {
  return _has_bit(3);
}
inline void FindResponse::clear_alternative_value_holder() {
  if (alternative_value_holder_ != NULL) alternative_value_holder_->::kad::ContactInfo::Clear();
  _clear_bit(3);
}
inline const ::kad::ContactInfo& FindResponse::alternative_value_holder() const {
  return alternative_value_holder_ != NULL ? *alternative_value_holder_ : *default_instance_->alternative_value_holder_;
}
inline ::kad::ContactInfo* FindResponse::mutable_alternative_value_holder() {
  _set_bit(3);
  if (alternative_value_holder_ == NULL) alternative_value_holder_ = new ::kad::ContactInfo;
  return alternative_value_holder_;
}

// optional bytes needs_cache_copy = 5;
inline bool FindResponse::has_needs_cache_copy() const {
  return _has_bit(4);
}
inline void FindResponse::clear_needs_cache_copy() {
  if (needs_cache_copy_ != &_default_needs_cache_copy_) {
    needs_cache_copy_->clear();
  }
  _clear_bit(4);
}
inline const ::std::string& FindResponse::needs_cache_copy() const {
  return *needs_cache_copy_;
}
inline void FindResponse::set_needs_cache_copy(const ::std::string& value) {
  _set_bit(4);
  if (needs_cache_copy_ == &_default_needs_cache_copy_) {
    needs_cache_copy_ = new ::std::string;
  }
  needs_cache_copy_->assign(value);
}
inline void FindResponse::set_needs_cache_copy(const char* value) {
  _set_bit(4);
  if (needs_cache_copy_ == &_default_needs_cache_copy_) {
    needs_cache_copy_ = new ::std::string;
  }
...
inline void FindResponse::set_needs_cache_copy(const void* value, size_t size) {
  _set_bit(4);
  if (needs_cache_copy_ == &_default_needs_cache_copy_) {
    needs_cache_copy_ = new ::std::string;
  }
  needs_cache_copy_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* FindResponse::mutable_needs_cache_copy() {
  _set_bit(4);
  if (needs_cache_copy_ == &_default_needs_cache_copy_) {
    needs_cache_copy_ = new ::std::string;
  }
